...
> [!IMPORTANT]
>
> **我需要验证在单个维度的原子操作下，如果逻辑依然崩溃，那就证明我的算数从根本上就是错误的。** 
> 
> *(这句话非常重要，它是构成 Aeon 整个导航系统的基石。)*
...
通过上述 6 个动作，我具备了几乎完整的时间导航系统。但是，我还想在此之上，更近一步。
...
**然而，在 Aeon 中，我把这个概念彻底贯彻到了整个导航系统中！**

---

我为上述 6 个动作，都定义了一套时间单位方法，从世纪到纳秒。例如这是 `Go` 的：
